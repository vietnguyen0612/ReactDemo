...
function TeamSectionOur() {
    return (  
        <div className="team-section-our">
            <div className="section-team-text-content">
                <div className="title">Our Team</div>
                <div className="text-content">We are Professional</div>
